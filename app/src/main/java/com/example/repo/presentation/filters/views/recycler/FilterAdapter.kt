package com.example.repo.presentation.filters.views.recycler
...
class FilterAdapter @Inject constructor() : RecyclerView.Adapter<FilterAdapter.FilterItemViewHolder>() {
    var filters = listOf<FilterView>()
    var selectedFilters = mutableListOf<String>()

    class FilterItemViewHolder @Inject constructor(val binding: FilterItemLayoutBinding) :
